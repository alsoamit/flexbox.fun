...
export default function Features() {
  return (
    <div className="bg-gray-800">
      <div className="c-container z-0 space-y-20 py-20 pt-48 md:space-y-40 md:pt-60">
        <div className="z-0 flex flex-col gap-8 md:flex-row md:gap-16">
        ...
        <div className="flex flex-col gap-8 md:flex-row md:gap-16">
          <div className="flex flex-1 flex-col justify-center space-y-6">
            ...
            <div className="flex">
              <Link
                href="/tutorials"
                className="group flex items-center gap-1 rounded-full bg-blue-500 p-3 px-6 font-bold text-white"
              >
                <svg
                  stroke="currentColor"
                  fill="none"
